    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#jenisFormModal">
                    <i class="typcn typcn-plus"></i>
                    Tambah Data
                </button>
                <a href="{{ route('A') }}" class="btn btn-success">
                    <i class="typcn typcn-download"></i> Export XSLX
                </a>
                <a href="{{ route('B') }}" class="btn btn-danger">
    ...
    <script>
        ...
        $(function() {
            ...
            $('.btn-delete').on('click', function(e) {
                let nama = $(".jenis" + $(this).attr('data-id')).text()
                console.log(nama)
                Swal.fire({
                    icon: 'error',
                    title: 'Hapus Data',
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editModal').on('show.bs.modal', function(e) {
                ...
                console.log(items)
                $('#name').val(items.name)
                $('#kategori_id').val(items.kategori_id)
                $('.form-edit').attr('action', `/jenis/${items.id}`)
            })
        })
    </script>
@endpush
