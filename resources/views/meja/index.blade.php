    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#MejaFormModal">
                    <i class="typcn typcn-plus"></i> 
                    Tambah Data
                </button>
                <a href="{{route('M')}}" class="btn btn-success">
                    <i class=" typcn typcn-download"></i> Export XSLX
                  </a>
                  <a href="{{route('N')}}" class="btn btn-danger">
    ...
    <script>
        ...
        $(function() {
            ...
            $('.btn-delete').on('click', function(e) {
                let nama = $(".meja" + $(this).attr('data-id')).text()
                console.log(nama)
                Swal.fire({
                    icon: 'error',
                    title: 'Hapus Data',
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editModal').on('show.bs.modal', function(e) {
                ...
                console.log(items)
                $('#nomor_meja').val(items.nomor_meja)
                $('#kapasitas').val(items.kapasitas)
                $('#status').val(items.status)
                $('.form-edit').attr('action', `/meja/${items.id}`)
            })
        })
    </script>
@endpush
