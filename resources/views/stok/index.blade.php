    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{route('G')}}" class="btn btn-success">
                    <i class=" typcn typcn-download"></i> Export XSLX
                  </a>
                  <a href="{{route('H')}}" class="btn btn-danger">
    ...
    <script>
        ...
        $(function() {
            ...
            $('.btn-delete').on('click', function(e) {
                let name = $(".stok" + $(this).attr('data-id')).text()
                console.log(name)
                Swal.fire({
                    icon: 'error',
                    title: 'Hapus Data',
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editModal').on('show.bs.modal', function(e) {
                ...
                console.log(items)
                $('#menu_id').val(items.menu_id)
                $('#jumlah').val(items.jumlah)
                $('.form-edit').attr('action', `/stok/${items.id}`)
            })
        })
    </script>
@endpush
